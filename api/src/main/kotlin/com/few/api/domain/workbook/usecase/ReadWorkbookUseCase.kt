...
class ReadWorkbookUseCase(
    ...
    fun execute(useCaseIn: ReadWorkbookUseCaseIn): ReadWorkbookUseCaseOut {
        ...
        val workbookRecord =
            workbookDao.selectWorkBook(SelectWorkBookRecordQuery(workbookId))
        ...
        val writerRecords =
            workbookMemberService.browseWriterRecords(
        ...
        return ReadWorkbookUseCaseOut(
            ...
            writers =
                writerRecords.toWriterDetails().map {
                    WriterDetail(
                        id = it.writerId,
                        name = it.name,
                        url = it.url,
            ...
            articles =
                workbookMappedArticles.toArticleDetails().map {
                    ArticleDetail(
                        id = it.articleId,
                        title = it.title,
                    )

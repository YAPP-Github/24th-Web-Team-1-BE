package com.few.crm.support.jpa

import com.few.crm.config.CrmJpaConfig
...
@Transactional(transactionManager = CrmJpaConfig.TRANSACTION_MANAGER)
annotation class CrmTransactional(

...
fun List<WorkBookSubscriberItem>.toMemberIds(): Set<Long> = this.map { it.memberId }.toSet()

fun List<WorkBookSubscriberItem>.toTargetWorkBookIds(): Set<Long> = this.map { it.targetWorkBookId }.toSet()
